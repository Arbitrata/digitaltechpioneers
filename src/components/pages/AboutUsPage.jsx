    ...
    return (
        <div className="mt-[125.22px]">
            ...
            <div className="w-full h-[432.33px] flex mt-[100px]">
                ...
                <div className="w-full h-[395px] grid pb-24 grid-cols-2 bg-dt-white gap-4 pl-[46.33px] pt-[24px] ml-4 shadow-2xl">
                    ...
                    <div className="flex items-center space-x-4 w-full">
                        ...
                        />
                        <div className="font-medium">
                            <h1 className="text-[17.7778px] text-dt-pap">
                                Mobile Application
                            </h1>
                        </div>
                    </div>
                            ...
                            <div className="w-full md:w-6/12 lg:w-5/12 mb-6 px-6 sm:px-6 lg:px-4">
                                <div className="flex flex-col">
                                    ...
                                    <div className="text-center mt-6">
                                        ...
                                        <div className="text-gray-700 font-light mb-2">
                                            Software Developer & Founder at digital tech solution
                                        </div>
                                        <div
