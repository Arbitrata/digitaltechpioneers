    ...
    <div className="lg:h-[660.44px] h-fit lg:w-full w-full lg:px-[80px] px-[33px] lg:pb-0 pb-10 bg-dt-blue bg-opacity-10">
      <div className="lg:flex block w-full h-full">
        <div className="lg:w-[50%] w-[100%]  h-full block text-left lg:pl-[29.33px] pl-0">
          ...
          <div className="mt-[57.78px] flex lg:gap-x-6 gap-x-0 lg:justify-normal justify-between h-fit w-full">
            <DtButton
              buttonText={"Learn more"}
              buttonStyle={"lg:w-[171.56px] w-fit text-dt-white"}
            />
            <DtButton
...
export const BudgeSection = () => {
  return (
    <div className="grid lg:grid-cols-4 justify-between grid-cols-1 lg:px-[100px] lg:py-0 py-[33px] px-[33px] lg:h-[145.56px] h-fit lg:gap-y-0 gap-6 w-full">
...
export const QuickSection = () => {
  return (
    <div className="lg:w-full w-full h-fit block lg:px-[140px] px-[33px]">
...
export const CallToAction = () => {
  return (
    <div className="h-[474.67px] w-full bg-dt-blue bg-opacity-10 relative">
      ...
      <img src="Pai Chart 1.png" className="absolute top-14 right-[230px]" />
        ...
        <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <form action="mt-[71.11px]">
            <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
              ...
              <div>
                <DtButton
                  buttonStyle={"h-[59.56px] ml-2 text-dt-white"}
